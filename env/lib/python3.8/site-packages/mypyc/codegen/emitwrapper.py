...
def generate_bin_op_reverse_only_wrapper(
    cl: ClassIR, fn_rev: FuncIR, emitter: Emitter, gen: "WrapperGenerator"
) -> None:
...
def generate_wrapper_core(
    ...
    for arg_name, arg in zip(arg_names, fn.args):
        ...
        generate_arg_check(arg_name, typ, emitter, error, optional=arg in optional_args)
...
class WrapperGenerator:
    ...
    def wrapper_name(self) -> str:
        ...
        return "{}{}{}".format(
            DUNDER_PREFIX, self.target_name, self.cl.name_prefix(self.emitter.names)
        )
