...
class UserDict(MutableMapping[_KT, _VT]):
    ...
    @classmethod
    def fromkeys(
        cls: Type[Self], iterable: Iterable[_KT], value: _VT | None = ...
    ) -> Self: ...
...
class defaultdict(Dict[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(
        self, __default_factory: Callable[[], _VT] | None, **kwargs: _VT
    ) -> None: ...
    @overload
    def __init__(
        self, __default_factory: Callable[[], _VT] | None, __map: Mapping[_KT, _VT]
    ) -> None: ...
    @overload
    def __init__(
        self,
        __default_factory: Callable[[], _VT] | None,
        __map: Mapping[_KT, _VT],
        **kwargs: _VT,
    ) -> None: ...
    @overload
    def __init__(
